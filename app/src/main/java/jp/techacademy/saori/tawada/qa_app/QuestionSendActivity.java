...
public class QuestionSendActivity extends AppCompatActivity implements View.OnClickListener, DatabaseReference.CompletionListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent date) {
        if (requestCode == CHOOSER_REQUEST_CODE) {
            ...
            //画像を取得
            Uri uri = (date == null || date.getData() == null) ? mPictureUri : date.getData();
    ...
    public void onClick(View v) {
        if (v == mImageView) {
            ...
            //UID
            date.put("uid", FirebaseAuth.getInstance().getCurrentUser().getUid());
            ...
            //添付画像が設定されていなければ画像を取り出してBASE64エンコードする
            if (drawable != null) {
                ...
                date.put("image", bitmapString);
            }

            genreRef.push().setValue(date,this);
            mProgress.show();
        }
    }
    ...
    public void showChooser() {
        ...
        startActivityForResult(cameraIntent, CHOOSER_REQUEST_CODE);
    }
